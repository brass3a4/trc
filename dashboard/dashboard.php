...
function wp_dashboard_setup() {
	...
	// Widget de Prueba
	wp_add_dashboard_widget( 'dashboard_prueba', __( 'Widget de Prueba' ), 'wp_dashboard_prueba' );
...
function wp_dashboard_prueba(){
    $num_posts = wp_count_posts( 'post' );
  
  echo "<h4>Hay ".$num_posts->publish.' publicaciones en total</h4>';
  ...
  //print_r($posts_array[3]->post_title);
